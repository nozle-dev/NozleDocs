...
<Info>
`CreditBalance`, `CreditHistory`, `BillingPortal`, and `useCredits` retain the legacy Lago wallet behavior. Use `ProductCreditBalance`, `CreditUsageHistory`, and the `useCredit*` hooks for product Credit Systems.
</Info>
