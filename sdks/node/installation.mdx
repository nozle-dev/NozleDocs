...
| `eventsUrl` | `string` | `http://localhost:3000` | Core API origin used by `track()`, credit-system discovery, and Entity subscriptions. Use `https://core.nozle.app` in production. |
