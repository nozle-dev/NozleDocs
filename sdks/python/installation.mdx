...
| `events_url` | `str` | `http://localhost:3000` | Core API origin for metered events, credit-system discovery, and Entity subscriptions. Use `https://core.nozle.app` in production. |
