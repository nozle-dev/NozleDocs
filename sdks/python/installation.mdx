...
| `base_url` | `str` | `http://localhost:8080` | Entitlement, credit, Entity, usage, and margin API origin. |
| `events_url` | `str` | `http://localhost:3000` | Core API origin for customer writes, billing resources, metered events, credit-system discovery, and Entity subscriptions. Use `https://core.nozle.app` in production. |
