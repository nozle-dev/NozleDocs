...
The `can()` endpoint returns margin fields only to trusted secret-key callers so backend policy can make profitability-aware decisions. Customer-session responses omit internal economics.
