...
|------------|------|----------|
| `pk_` | Publishable | Safe for public client-side catalog, entitlement, and checkout flows. It cannot read the credit ledger. |
...
| `csess_` | Customer session | Short-lived browser credential bound to one customer and `credits:read`. Mint it from your backend. |
