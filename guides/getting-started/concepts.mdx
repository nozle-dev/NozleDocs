...
| `event_code` | What was used (maps to a feature) |
...
Entitlements are checked from a trusted backend through the [`can()` endpoint](/guides/entitlements/can-endpoint) or the Node.js and Python SDKs. React gate components render the backend-owned result without exposing customer credentials in the browser.

<CardGroup cols={2}>
  <Card title="Entitlements Overview" href="/guides/entitlements/overview" />
  <Card title="Backend-authorized updates" href="/guides/entitlements/real-time" />
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="React SDK (public catalog + BFF checkout)" href="/sdks/react/installation" />
</CardGroup>
