...
For public pricing and checkout, a publishable key is sufficient. For balances and operation history, mint a customer session in your backend and pass it to `BillingProvider`:
