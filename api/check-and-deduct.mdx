...
api: "POST https://api.nozle.app/engine/api/v1/check-and-deduct"
---

Base URL: `https://api.nozle.app/engine/api/v1`.

<Warning>
Legacy wallet adapter. It does not apply Feature conversion rates or the product-credit source ledger. New integrations must use [Track and Consume Credits](/api/usage-track).
</Warning>
