...
<Warning>
Legacy wallet adapter. It does not apply Billable Metric conversion rates or the product-credit source ledger. New integrations must use [Track and Consume Credits](/api/usage-track).
</Warning>
