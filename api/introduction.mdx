...
| Base URL | Use it for |
|---|---|
| `https://api.nozle.app/core/api/v1` | Customers, plans, subscriptions, usage events, invoices, wallets, payments, taxes, and billing configuration |
| `https://api.nozle.app/engine/api/v1` | Checkout, product credits, entitlements, margin intelligence, and other Nozle extensions |
