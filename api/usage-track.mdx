...
description: Atomically consume credits and queue the matching billing event
---

**Auth:** secret key only. The customer, Billable Metric, and optional Credit System must belong to the authenticated organization.
