...
<Warning>
All cost model endpoints require a secret key (`sk_`) and are scoped to that key's organization. Publishable keys and customer sessions receive a 403 Forbidden response.
</Warning>
