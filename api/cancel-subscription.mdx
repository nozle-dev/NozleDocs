...
api: "DELETE https://api.nozle.app/engine/api/v1/subscriptions/{id}"
---
...
```bash
curl --request DELETE \
  'https://api.nozle.app/engine/api/v1/subscriptions/sub_123?customer_id=cust_123&cancellation_policy=end_of_period' \
