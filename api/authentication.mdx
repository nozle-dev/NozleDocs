...
- **Publishable keys** (`pk_nozle_...`) can access: `can`, plans, checkout, billing status, subscriptions, invoices, credits, ws-token
- **Secret keys** (`sk_nozle_...`) can access everything above PLUS: subscribe, cost-models, admin/reload, margin/*, and all billing engine endpoints
