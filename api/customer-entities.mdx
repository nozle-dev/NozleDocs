...
**Auth:** secret/internal credential. When API permissions are enabled, reads require `entity:read` and mutations require `entity:write`. Browser credentials cannot read the Entity directory.
